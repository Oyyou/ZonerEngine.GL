...
namespace ZonerEngine.Testing
{
  public class TestingState : State
  {
    ...
    public override void LoadContent()
    {
      ...
      {
        map.Add(new GL.Components.MappedComponent(null, () => new Rectangle(point.X, point.Y, 1, 1)));
      }

      map.WriteMap();

      //map.Add(new GL.Components.MappedComponent(null, () => new Rectangle(-1, -1, 2, 2)));
      //map.Add(new GL.Components.MappedComponent(null, () => new Rectangle(0, 0, 2, 2)));
      //map.Add(new GL.Components.MappedComponent(null, () => new Rectangle(1, 1, 2, 2)));
